...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-waterline/node_modules/waterline/lib/waterline/error/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-waterline/node_modules/waterline/lib/waterline/error/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-waterline/node_modules/waterline/lib/waterline/error/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 * @return {WLError}
 */
module.exports = <span class="fstat-no" title="function not covered" >function errorify(err) {</span>
&nbsp;
  // If specified `err` is already a WLError, just return it.
<span class="cstat-no" title="statement not covered" >  if (typeof err === 'object' &amp;&amp; err instanceof WLError) <span class="cstat-no" title="statement not covered" >return err;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return duckType(err);</span>
};
&nbsp;
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function duckType(err) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  if (/* _isValidationError(err) || */ _isConstraintViolation(err)) {</span>
&nbsp;
    // Dress `unique` rule violations to be consistent with other
    // validation errors.
<span class="cstat-no" title="statement not covered" >    return new WLValidationError(err);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  return new WLError({</span>
    originalError: err
  });
}
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function _isConstraintViolation(err) {</span>
&nbsp;
  // If a proper error code is specified, this error can be classified.
<span class="cstat-no" title="statement not covered" >  if (err &amp;&amp; typeof err === 'object' &amp;&amp; err.code === 'E_UNIQUE') {</span>
